------------------------------------------------------------------------------
-- measurtool.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
use measurtool_v1_00_a.user_logic;
...
end entity measurtool;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of measurtool is
...
--  constant USER_SLV_NUM_REG               : integer              := 8;
  constant USER_NUM_REG                   : integer              := 1 + (C_NUM_TRIG_SIGNALS*2);
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity measurtool_v1_00_a.user_logic
    generic map
    (
